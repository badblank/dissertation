...
$(document).ready(function(){
    ...
    $("#sub_all_add").click(function(){
        
        //$("#form_li").submit();
        $("#date_all_add").removeAttr("readonly");
        if($("#date_all_add").val()==""){
            alert("请选择日期");
        }else{
          var time =$("#date_all_add").val();
          $(".time").val(time);
          $(".time").attr("type","input");
          $(".time").attr("readonly","true");
          $(".time").css("border","none");
         
//        $("#time").attr("disabled","disabled");
          //$("#myalert1").hide();//隐藏盒子
          $('#myalert1').modal('hide');//关闭模态框
        }
    })
