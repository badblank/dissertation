            ...
            <div class="modal-body">
                <form class="form-horizontal" id="form_li" action="<?php echo site_url("Backend/add_absence")?>" method="post">
                    <div class="form-group">
                        <label for="dtp_input2" class="col-md-3 control-label">此学生尚未提交！</label>
...
<div class="modal fade" id="myalert1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="exampleModalLabel">选择考勤日期</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="form_li" action="<?php echo site_url("Backend/add_absence")?>" method="post">
                    <div class="form-group">
                        <label for="dtp_input2" class="col-md-3 control-label">请选择考勤日期</label>
                        <div class="input-group date form_date col-md-5" data-date="" data-date-format="" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                            <input class="form-control" size="16" id="date_all_add" name="date" type="text" value="" readonly>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="sub_all_add" class="btn btn-primary btn-sm" name="submit" >确认</button>
